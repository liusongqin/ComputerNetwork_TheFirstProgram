...
def tests_to_run(forwarder):
    ...
    BasicTest.BasicTest(forwarder, "D:study\sophomore1\ComputerNetwork\TheFirstProgram\README.txt")
    RandomDropTest.RandomDropTest(forwarder, "D:study\sophomore1\ComputerNetwork\TheFirstProgram\README.txt")
