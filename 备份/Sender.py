...
'''
sys.argv =[sys.argv[0],'-fD:study\sophomore1\ComputerNetwork\TheFirstProgram\s.mp4','-p33123','-a127.0.0.1']
            ...
            while window:
                ...
                if response is not None:
                    if self.handle_response(response):#校对校验码                     
                        ...
                        if rtt_sample<1.5 and rtt_sample>0.04:#防止样本计算的是程序运行时间导致得到特别离谱的结果(如样本值小于0.04那大概率是算的程序运行的时间)
